...
struct WorkoutEquipmentImagePickerRow: View {
    ...
    private var imageOptions: [WorkoutEquipmentImageOption] {
        options.map { option in
            ...
            let representative = matchingExercises.first { $0.imageURL != nil && !$0.isCardio }
                ?? matchingExercises.first { $0.imageURL != nil }
...
private struct WorkoutTargetMuscleGroup: Identifiable, Hashable {
    ...
    nonisolated static let all: [WorkoutTargetMuscleGroup] = [
        .init(id: "chest", title: "Chest", detail: String(localized: "Pecs"), systemImage: "figure.strengthtraining.traditional", muscles: StrengthWorkoutSplitGroup.Vocabulary.chest),
        .init(id: "shoulders", title: "Shoulders", detail: String(localized: "Delts"), systemImage: "figure.strengthtraining.functional", muscles: StrengthWorkoutSplitGroup.Vocabulary.shoulders),
        .init(id: "abdominals", title: "Abdominals", detail: String(localized: "Abdominals"), systemImage: "figure.core.training", muscles: StrengthWorkoutSplitGroup.Vocabulary.core),
        .init(id: "biceps", title: "Biceps", detail: String(localized: "Front upper arm"), systemImage: "dumbbell.fill", muscles: StrengthWorkoutSplitGroup.Vocabulary.biceps),
        .init(id: "triceps", title: "Triceps", detail: String(localized: "Back upper arm"), systemImage: "dumbbell.fill", muscles: ["Triceps"]),
        .init(id: "forearms", title: "Forearms", detail: String(localized: "Grip and lower arm"), systemImage: "dumbbell.fill", muscles: StrengthWorkoutSplitGroup.Vocabulary.forearms),
        .init(id: "lats", title: "Lats", detail: String(localized: "Width-focused back"), systemImage: "figure.pullup", muscles: ["Lats"]),
        .init(id: "middle_back", title: "Middle Back", detail: String(localized: "Rows and upper-back thickness"), systemImage: "figure.pullup", muscles: ["Upper Back", "Back", "Rhomboids", "Middle Back"]),
        .init(id: "lower_back", title: "Lower Back", detail: String(localized: "Spinal erectors"), systemImage: "figure.flexibility", muscles: ["Lower Back", "Spine"]),
        .init(id: "traps", title: "Traps", detail: String(localized: "Upper back and neck line"), systemImage: "figure.strengthtraining.functional", muscles: StrengthWorkoutSplitGroup.Vocabulary.traps),
        .init(id: "quadriceps", title: "Quadriceps", detail: String(localized: "Quadriceps"), systemImage: "figure.run", muscles: StrengthWorkoutSplitGroup.Vocabulary.quads),
        ...
        .init(id: "calves", title: "Calves", detail: String(localized: "Lower leg"), systemImage: "figure.run", muscles: StrengthWorkoutSplitGroup.Vocabulary.calves),
        .init(id: "abductors", title: "Abductors", detail: String(localized: "Outer hip"), systemImage: "figure.walk", muscles: ["Abductors"]),
        .init(id: "adductors", title: "Adductors", detail: String(localized: "Inner thigh"), systemImage: "figure.walk", muscles: ["Adductors", "Inner Thighs", "Groin"]),
        .init(id: "neck", title: "Neck", detail: String(localized: "Neck"), systemImage: "figure.stand", muscles: StrengthWorkoutSplitGroup.Vocabulary.neck)
    ]
    ...
    private static let legacyAliases: [String: [String]] = [
        "core": StrengthWorkoutSplitGroup.Vocabulary.core,
        "abs / core": StrengthWorkoutSplitGroup.Vocabulary.core,
        "quads": StrengthWorkoutSplitGroup.Vocabulary.quads,
        "hips": ["Abductors", "Adductors"],
        "arms": StrengthWorkoutSplitGroup.Vocabulary.biceps + StrengthWorkoutSplitGroup.Vocabulary.triceps + StrengthWorkoutSplitGroup.Vocabulary.forearms,
        "back": StrengthWorkoutSplitGroup.Vocabulary.back + StrengthWorkoutSplitGroup.Vocabulary.lowerBack + StrengthWorkoutSplitGroup.Vocabulary.traps,
        "legs": StrengthWorkoutSplitGroup.Vocabulary.quads + StrengthWorkoutSplitGroup.Vocabulary.posteriorLegs + StrengthWorkoutSplitGroup.Vocabulary.calves + ["Abductors", "Adductors"]
    ]
}
