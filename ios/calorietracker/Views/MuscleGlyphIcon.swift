...
private enum MuscleGlyphKind {
    ...
    private init(muscleName: String) {
        ...
        case "abdominals", "abs", "core", "obliques", "lower abs":
            self = .abs
        case "abductors":
            self = .abductors
        case "adductors", "inner thighs", "groin":
            self = .adductors
        case "biceps", "brachialis":
            self = .biceps
        case "triceps":
            self = .triceps
        case "forearms", "wrists", "wrist extensors", "wrist flexors", "grip muscles":
            self = .forearms
        case "calves", "soleus":
            self = .calves
        case "chest", "pectorals", "upper chest", "serratus anterior":
            self = .chest
        case "glutes":
            self = .glutes
        case "hamstrings":
        ...
        case "lower back", "spine":
            self = .lowerBack
        case "middle back", "upper back", "rhomboids", "back":
            self = .middleBack
        case "neck", "sternocleidomastoid", "levator scapulae":
            self = .neck
        case "quadriceps", "quads":
            self = .quadriceps
        case "shoulders", "delts", "rear deltoids", "rotator cuff":
            self = .shoulders
        case "traps":
            self = .traps
        default:
