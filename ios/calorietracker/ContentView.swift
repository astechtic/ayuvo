...
struct ProfileView: View {
    ...
    @State private var showExportHealthData = false
    @State private var showImportHealthData = false
    @State private var showClearHealthDataConfirmation = false
    ...
    private var settingsList: some View {
            List {
                ...
                Section {
                    ...
                    Toggle(isOn: Binding(
                        get: { healthDataStore.showsHomeTile },
                        set: { healthDataStore.setHomeTilesVisible($0) }
                    )) {
                        Label {
                            Text("Show Health tiles on Home")
                        } icon: {
