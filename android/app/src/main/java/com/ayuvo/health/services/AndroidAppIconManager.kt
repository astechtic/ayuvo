...
object AndroidAppIconManager {
    ...
    private const val COMPONENT_NAMESPACE = "com.ayuvo.health"

    private val launcherActivities = mapOf(
        AppThemeColor.ROSE to "RoseLauncherActivity",
    ...
    private fun applyLauncherIcon(context: Context, themeColor: AppThemeColor) {
        val selectedLauncher = launcherActivities[themeColor] ?: launcherActivities.getValue(AppThemeColor.ROSE)
