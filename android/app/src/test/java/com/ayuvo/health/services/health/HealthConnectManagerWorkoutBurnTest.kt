...
class HealthConnectManagerWorkoutBurnTest {
    ...
    fun workoutBurnClientRecordIdRoundTripsStableDateAndSession() {
        ...
        assertEquals("ayuvo_workout_burn|2026-07-20|$id", clientRecordId)
    ...
    fun workoutBurnClientRecordIdRejectsMalformedOrNonCanonicalValues() {
        ...
        assertNull(HealthConnectManager.parseWorkoutBurnClientRecordId("ayuvo_$id"))
        assertNull(HealthConnectManager.parseWorkoutBurnClientRecordId("ayuvo_workout_burn|2026-07-20|not-a-uuid"))
        assertNull(HealthConnectManager.parseWorkoutBurnClientRecordId("ayuvo_workout_burn|2026-07-20|$id|extra"))
    }
    ...
    fun externalTotalRemovesOwnEstimatedWorkoutBurnWithoutAddingItBack() {
        ...
        // Ayuvo's own estimate, so the evidence total must be 1,700 + 420 = 2,120.
        assertEquals(
            2_120.0,
