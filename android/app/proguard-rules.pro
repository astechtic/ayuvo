...
-keep,includedescriptorclasses class com.ayuvo.health.**$$serializer { *; }
-keepclassmembers class com.ayuvo.health.** {
    *** Companion;
}
-keepclasseswithmembers class com.ayuvo.health.** {
    kotlinx.serialization.KSerializer serializer(...);
}
# Enum @Serializable lookups need their members preserved for KSerializer.
-keepclassmembers enum com.ayuvo.health.** { *; }
...
# itself.
-keep class com.ayuvo.health.widget.** { *; }
...
-keepclassmembers class com.ayuvo.health.data.ExerciseRecord {
  <init>();
  <fields>;
}
